using System;
using HardwareConnection.Packets.Filter;
...
/// <summary>
    ...
    /// so in the eyes of the <see cref="PacketTransporter"/>, packets are never handled
    /// </para>
    /// </summary>
    public class PacketListener {
    /// <summary>
    /// The filter that will be used to see if this <see cref="PacketListener"/> is allowed to be notified of
    /// a <see cref="Packet"/> received by the <see cref="PacketTransporter"/>
    /// </summary>
    public PacketFilter Filter { get; }
        ...
        /// <see langword="false"/> if the same <see cref="Packet"/> should be sent to other <see cref="PacketListener"/>s (by the <see cref="PacketTransporter"/>)
